...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hpbmhudjQ2IiwiYSI6ImNrdDhibW1kazEwbnMydmxqZTN0NTNwYjgifQ.LegkQHZ53fkU8hcpa-Py2w'; // eslint-disable-next-line vars-on-top

  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/chinhnv46/ckt8clvlp4tcr17o52sa0e0zu',
    scrollZoom: false //   center: [105.804817, 21.028511],
    //zoom: 10,
    //interactive: true,
  ...
  locations.forEach(function (loc) {
    ...
    var el = document.createElement('div'); //tạo một div element
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(true); //location.assign('/');
...
},{"./alert.js":"alert.js","axios":"../../node_modules/axios/index.js"}],"updateSetting.js":[function(require,module,exports) {
"use strict";
...
if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); //lấy phần tử id="map", phân tích chuỗi Json
